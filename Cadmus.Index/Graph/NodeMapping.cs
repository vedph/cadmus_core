...
namespace Cadmus.Index.Graph
{
    ...
    public class NodeMapping
    {
        ...
        /// <summary>
        /// Gets or sets the slot template. This defines a virtual "slot" named
        /// after the value of the template, whose value is the UID of the
        /// target node for this mapping. For instance, if you are mapping an
        /// EID pin like <c>eid=angel-1v</c>, and you set <c>slot={pin-value}</c>,
        /// then the UID of the node generated by that mapping will be saved
        /// in the temporary mapper state under a slot keyed with the value of
        /// the template, e.g. <c>angel-1v</c>. This allows other mappings to
        /// refer to this node via the same slot key, using the <c>$slot</c>
        /// macro.
        /// </summary>
