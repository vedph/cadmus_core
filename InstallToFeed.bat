...
c:\exe\nuget add .\Cadmus.Parts\bin\Debug\Cadmus.Parts.2.2.55.nupkg -source C:\Projects\_NuGet
...
c:\exe\nuget add .\Cadmus.Seed.Parts\bin\Debug\Cadmus.Seed.Parts.1.0.58.nupkg -source C:\Projects\_NuGet
