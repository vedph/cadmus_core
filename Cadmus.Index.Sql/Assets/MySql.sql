...
--
-- Host: 127.0.0.1    Database: cadmus-index
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'cadmus-index'
--
/*!50003 DROP FUNCTION IF EXISTS `COMPARE_STRING` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `COMPARE_STRING`( s1 text, s2 text) RETURNS int
    DETERMINISTIC
BEGIN 
...
/*!50003 DROP FUNCTION IF EXISTS `SIMILARITY_STRING` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
-- Dump completed on 2020-04-15 17:54:08
