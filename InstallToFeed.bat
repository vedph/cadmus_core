...
c:\exe\nuget add .\Cadmus.Philology.Parts\bin\Debug\Cadmus.Philology.Parts.2.2.48.nupkg -source C:\Projects\_NuGet
...
c:\exe\nuget add .\Cadmus.Seed.Philology.Parts\bin\Debug\Cadmus.Seed.Philology.Parts.1.0.45.nupkg -source C:\Projects\_NuGet
pause
