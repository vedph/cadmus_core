...
pause
c:\exe\nuget add .\Cadmus.Core\bin\Debug\Cadmus.Core.2.0.4.nupkg -source C:\Projects\_NuGet
c:\exe\nuget add .\Cadmus.Parts\bin\Debug\Cadmus.Parts.2.0.5.nupkg -source C:\Projects\_NuGet
