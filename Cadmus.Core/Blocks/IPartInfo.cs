...
{
    /// <summary>
    /// Essential information about a part.
    /// </summary>
    public interface IPartInfo : IHasVersion
    {
        /// <summary>
        ...
        /// original text and to that of its later copy. In this case, a role ID
        /// helps selecting the desired part from an item.</remarks>
